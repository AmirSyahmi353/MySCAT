    ...
    <div class="d-flex align-items-center">
        ...
        <div>
            <h1 class="h4 text-dark fw-bold mb-1">
                Hai to the Dietitian Dashboard, {{ Str::ucfirst(Auth::user()->name) ?? 'Dietitian' }}!
            </h1>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle">
                ...
                @forelse ($recentPatients as $p)
                    <tr class="clickable-row" data-href="{{ route('patients.show', $p->_id) }}">
                ...
                @empty
                    <tr><td colspan="5" class="text-center text-muted py-3">No recent patient data.</td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
...
<div class="row justify-content-center mb-5">
    <div class="col-lg-4 col-md-6 col-sm-10">
        <a href="{{ route('patients.index') }}" class="quick-access-small d-flex align-items-center gap-3 text-white text-decoration-none">
